...
\hypersetup{
	pdftitle={Afleidingen Trillingen \& Golven},
	pdfsubject={Please talk to me Rebecca},
...
\href{https://github.com/Fail-X-bot}{Felix Lots}
\section*{Change log}
\begin{itemize}
  ...
  \item \href{https://github.com/debber1/Afleidingen_TG/issues/16}{Fout in afleiding 6}
	\item \href{https://github.com/debber1/Afleidingen_TG/issues/24}{Fout in afleiding 13}
...
\end{itemize}
\section*{Historisch}
In 2022 waren afleidingen 3, 8, 9, 10, 15, 18, 19, 21, 22, 23, 25 en 33 niet te kennen.\\
In 2024 zijn afleidingen 1, 2, 4, 5, 6, 7, 11, 12, 16, 17, 20, 24, 27, 28, 29, 30, 32 te kennen en dat van de voortplantingssnelheid van geluid dat momenteel nog ontbreekt.
\newpage
\section{Ongedempte trilling '23-'24}
...
\newpage
\section{Energie bij ongedempte trilling '23-'24}
...
\end{align*}
\newpage
\section{Beweging pendulum '23-'24}
...
\newpage
\section{Gedempte harmonische trilling '23-'24}
\begin{figure}[htbp]
	\centering
...
\newpage
\section{Gedwongen trillingen '23-'24}
...
\newpage
\section{Golf vergelijking '23-'24}
...
\end{figure}\\
We bepalen nu hoe $y_1+y_2$ er wiskundig uit zal zien aan de hand van de \href{https://nl.wikipedia.org/wiki/Lijst_van_goniometrische_gelijkheden#Formules_van_Simpson}{regels van Simpson}:
\begin{align*}
	y & = y_1+y_2\\
...
\end{align*}
Hierbij gebruiken we wederom de \href{https://nl.wikipedia.org/wiki/Lijst_van_goniometrische_gelijkheden#Formules_van_Simpson}{regels van Simpson}. Omdat de uiteinden van de snaar (met lengte $L$) vast gehouden worden, kunnen we volgende randvoorwaarden stellen:
\begin{align*}
...
\newpage
\section{Energie transport in een golf '23-'24}
\begin{figure}[h]
	\centering
...
\begin{align*}
	...
	\Delta P &= \rho vv'
\end{align*}
Met de compressie- of bulk-modulus \[B = \frac{-\Delta P}{\frac{\Delta V}{V_0}} \] \[\Delta P = -B \frac{\Delta V}{V_0}\] We vullen de eerder bekomen vergelijkingen in voor $\Delta V $en $V_0$ in: \[\Delta P = B \frac{v'}{v}\] Wanneer we deze gelijkstellen aan de voorgaande vergelijking voor $\Delta P$ dan wordt volgende vergelijking verkregen: \[B \frac{v'}{v} = \rho v v'\] \[v^2 = \frac{B}{\rho}\] \[v = \sqrt{\frac{B}{\rho}}\]
\newpage
...
\newpage
\section{Staande golven in een open buis '23-'24}
...
\end{align*}
Hierbij gebruiken we de \href{https://nl.wikipedia.org/wiki/Lijst_van_goniometrische_gelijkheden#Formules_van_Simpson}{regels van Simpson}. Vervolgens kijken we naar de verplaatsing in de buis:
\begin{align*}
	D_S(x,t)&=Asin(kx+\omega t+\frac{\pi}{2})+Asin(kx-\omega t+\frac{\pi}{2})\\
	&= 2Asin(kx+\frac{\pi}{2})cos(\omega t)
\end{align*}
Hierbij gebruiken we nogmaals de \href{https://nl.wikipedia.org/wiki/Lijst_van_goniometrische_gelijkheden#Formules_van_Simpson}{regels van Simpson}.\\
...
\end{figure}%\\
\newpage
\section{Staande golven in een half open buis '23-'24}
\begin{figure}[!h]
	\centering
	\begin{subfigure}{.5\textwidth}
		\centering
...
\end{align*}
Door beide op te tellen en de \href{https://nl.wikipedia.org/wiki/Lijst_van_goniometrische_gelijkheden#Formules_van_Simpson}{regels van Simpson} toe te passen krijgen we:
\begin{equation*}
...
\end{align*}
\newpage
\section{Golfvergelijking van een elektromagnetische golf '23-'24}
...
\end{align*}
\newpage
\section{Werking sferische spiegel '23-'24}
...
\newpage
\section{Afleiding van Snellius '23-'24}
\begin{figure}[!h]
	\centering
...
\newpage
\section{Experiment van Young '23-'24}
\label{sec:young}
...
\newpage
\section{Buiging door één opening '23-'24}
